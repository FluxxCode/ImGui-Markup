#ifndef IMGUI_MARKUP_SRC_ITEMS_PANEL_H_
#define IMGUI_MARKUP_SRC_ITEMS_PANEL_H_
...
class Panel : public ItemBase, public WindowFlags
{
public:
...
#endif  // IMGUI_MARKUP_SRC_ITEMS_PANEL_H_
