#ifndef IMGUI_MARKUP_SRC_ITEMS_COMMON_ITEM_MAPPING_H_
#define IMGUI_MARKUP_SRC_ITEMS_COMMON_ITEM_MAPPING_H_
...
#endif  // IMGUI_MARKUP_SRC_ITEMS_COMMON_ITEM_MAPPING_H_
