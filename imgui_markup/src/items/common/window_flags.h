#ifndef IMGUI_MARKUP_SRC_IMGUI_MARKUP_ITEMS_COMMON_WINDOW_FLAGS_H_
#define IMGUI_MARKUP_SRC_IMGUI_MARKUP_ITEMS_COMMON_WINDOW_FLAGS_H_
...
protected:
    ...
    /**
     * Generates the ImGuiWindowFlags based on the attributes from this item.
     *
...
#endif  // IMGUI_MARKUP_SRC_IMGUI_MARKUP_ITEMS_COMMON_WINDOW_FLAGS_H_
