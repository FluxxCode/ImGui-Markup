...
enum class LexerTokenType
{
    ...
    kFloat,          // Float
    kBool,           // Bool
    kID,             // Words containing alphabetical, numeric characters,
                     // '_' and '.'
    kEOF             // End of file
};
...
private:
    ...
    */
    ...
    /**
     * Overwrite the current line position
     *
     * @param[in] position = New line position
     */
    void OverwriteCurrentPosition(size_t position);
