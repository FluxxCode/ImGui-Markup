#ifndef IMGUI_MARKUP_INCLUDE_PARSER_PARSER_RESULT_H_
#define IMGUI_MARKUP_INCLUDE_PARSER_PARSER_RESULT_H_
...
#endif  // IMGUI_MARKUP_INCLUDE_PARSER_PARSER_RESULT_H_
